...
import { badRequestError, conflictError, unauthorizedError, } from "../middleware/error-handler.js";
...
export async function requestRegistrationOtp(payload) {
    ...
    if (!sent) {
        throw badRequestError("Could not send OTP email right now. Please try again.");
    }
    return {
        email,
        expiresAt,
