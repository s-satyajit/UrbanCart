...
import { askGeminiAboutStore, isGeminiConfigured, } from "../services/gemini.service.js";
    ...
    return {
        ...
        stats: [
            ...
            },
            {
                ...
                detail: resolvedCategories.slice(0, 4).join(", ") ||
        ...
        ai: {
            ...
            subtitle: "Smart FAQs powered by Gemini and grounded in your current store data, policies, and support channels.",
...
${productSnapshot
        .map((product) => `- ${product.title} | Category: ${product.category} | Price: ${formatCurrency(product.price)} | Badge: ${product.badge || "None"} | Stock: ${product.stock}`)
        .join("\n")}
